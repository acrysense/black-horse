...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (catalogFilter && catalogFilterTrigger) {
  ...
  var myNewCatalogSlider;
  var myServicesSlider;
  var breakpointChecker = function breakpointChecker() {
    if (breakpoint.matches === true) {
      if (myNewCatalogSlider !== undefined) myNewCatalogSlider.destroy(true, true);
      if (myServicesSlider !== undefined) myServicesSlider.destroy(true, true);
      return;
  ...
  var enableSwiper = function enableSwiper() {
    ...
    if (catalogSlider) {
      myNewCatalogSlider = new Swiper(catalogSlider, {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        pagination: {
    ...
    if (servicesSlider) {
      myServicesSlider = new Swiper(servicesSlider, {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        pagination: {
